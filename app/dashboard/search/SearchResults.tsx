        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            {query
              ...
              : "Enter a search term to find students, classes, or courses."}
          </p>
        </div>
        ...
        <div className="grid gap-6">
          {students.length > 0 && (
            <Card>
              ...
              <CardContent className="p-0">{students.map(renderResultItem)}</CardContent>
            </Card>
          )}
          ...
          {classrooms.length > 0 && (
            <Card>
              ...
              <CardContent className="p-0">{classrooms.map(renderResultItem)}</CardContent>
            </Card>
          )}
          ...
          {courses.length > 0 && (
            <Card>
              ...
              <CardContent className="p-0">{courses.map(renderResultItem)}</CardContent>
            </Card>
          )}
        </div>
      )}
